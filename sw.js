...
const CACHE_NAME = "zro_zrro-public-v37";
const CORE_ASSETS = ["./", "./index.html", "./styles.css?v=37", "./app.js?v=37", "./favicon.svg"];
const API_ORIGIN = "https://zro-zrro-memberships.zx87s.chatgpt.site";
...
self.addEventListener("activate", (event) => {
  event.waitUntil((async () => {
    ...
    await Promise.all(keys.filter((key) => key.startsWith("zro_zrro-public-") && key !== CACHE_NAME).map((key) => caches.delete(key)));
